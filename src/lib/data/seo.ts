...
export const seoConfig = {
  ...
  defaultDescription: "Frontend Engineer specializing in Svelte/SvelteKit, TypeScript, React.js and modern web development. Creating fast, accessible, and user-friendly digital experiences.",
...
export const pageMetadata = {
  ...
  resume: {
    ...
    description: "View the professional resume of Alina Akseninko, Frontend Engineer with experience in Svelte/SvelteKit, TypeScript, React, and modern web technologies.",
    keywords: [
