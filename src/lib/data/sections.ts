...
const featured_projects = [
  {
    ...
    image: {
      src: arts_center,
      alt: "Arts.Center social platform interface showing artist profiles and artwork gallery built with SvelteKit",
    },
  ...
  },
  {
    ...
    image: {
      src: blog_platform,
      alt: "Modern blog platform interface built with React.js showing article list and clean reading experience",
    },
