...
<div class=" flex flex-col items-center lg:flex-row {isEven ? '' : 'lg:flex-row-reverse'}">
	<div class="mb-6 flex w-full items-end justify-between lg:hidden">
		<div><ProjectCardHeader title={project.title} /></div>
		<div><ArrowUpRight size={36} class="text-stone-200" /></div>
	</div>
